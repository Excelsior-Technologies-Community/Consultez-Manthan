  ...
  const [items, setItems] = useState([
    {
      ...
      price: 36,
      qty: 1,
      img: "https://html.kodesolution.com/2025/consultez-html-v2/images/resource/products/3.jpg",
    },
    {
      id: 2,
      ...
      price: 115,
      qty: 1,
      img: "https://html.kodesolution.com/2025/consultez-html-v2/images/resource/products/2.jpg",
    },
    {
      id: 3,
      ...
      price: 68,
      qty: 1,
      img: "https://html.kodesolution.com/2025/consultez-html-v2/images/resource/products/1.jpg",
    },
  ]);
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div>
            ...
            <div className="border p-6 space-y-4">
              ...
              />
              <button className="px-6 py-3 bg-gray-100">
                UPDATE TOTALS
              </button>
            </div>
          </div>
